/*
    ...
    DllEntry char* LkProperties(char** error, const char* const credentialOptions, const char* const filename, const char* const lkPropetiesOptions, JSON_FORMAT jsonFormat, const char* const customVars, uint32_t receiveTimeout);
