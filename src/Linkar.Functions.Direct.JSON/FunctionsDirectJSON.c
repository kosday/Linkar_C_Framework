...
{
	DataFormatTYPE inputFormat = DataFormatTYPE_JSON;
	char* result = Base_LkUpdate(error, credentialOptions, filename, records, updateOptions, inputFormat, jsonFormat, customVars, receiveTimeout);
...
/*
	...
	See Also:
		...
		<Release Memory>
*/
DllEntry char* LkUpdatePartial(char** error, const char* const credentialOptions, const char* const filename, const char* const records, const char* const updateOptions, JSON_FORMAT jsonFormat, const char* const customVars, uint32_t receiveTimeout)
{
	DataFormatTYPE inputFormat = DataFormatTYPE_JSON;
	char* result = Base_LkUpdatePartial(error, credentialOptions, filename, records, "", updateOptions, inputFormat, jsonFormat, customVars, receiveTimeout);
...
{
	DataFormatTYPE inputFormat = DataFormatTYPE_JSON;
	char* result = Base_LkNew(error, credentialOptions, filename, records, newOptions, inputFormat, jsonFormat, customVars, receiveTimeout);
...
/*
	...
	Example:
		...
		public char* MySelect(char** error)
		{
			...
			JSON_FORMAT jsonFormat = JSON_FORMAT_JSON;
			result = LkSelect(error, credentials, "LK.CUSTOMERS", "", "BY ID", "", "", options, jsonFormat, "", 600);
			LkFreeMemory(options);
			LkFreeMemory(credentials);
			return result;
		}
...
{
	char* result = Base_LkSelect(error, credentialOptions, filename, selectClause, sortClause, dictClause, preSelectClause, selectOptions, jsonFormat, customVars, receiveTimeout);
...
/*
	...
	Example:
		...
		char* MySubroutine(char** error)
		{
			...
			result = LkSubroutine(&error, credentialOptions, subroutineName, argsNumber, arguments, "", 0);
...
/*
	...
	Example:
		...
		char* MyLkProperties(char** error)
		{
			...
			result = LkProperties(error, credentials, "LK.CUSTOMERS", options, JSON_FORMAT_JSON, "", 600);
			LkFreeMemory(options);
			LkFreeMemory(credentials);
			return result;
		}
	...
	See Also:
		...
		<Release Memory>
*/
DllEntry char* LkProperties(char** error, const char* const credentialOptions, const char* const filename, const char* const lkPropertiesOptions, JSON_FORMAT jsonFormat, const char* const customVars, uint32_t receiveTimeout)
{
	char* result = Base_LkProperties(error, credentialOptions, filename, lkPropertiesOptions, jsonFormat, customVars, receiveTimeout);
