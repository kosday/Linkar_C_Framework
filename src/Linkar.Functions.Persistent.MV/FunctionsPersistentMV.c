...
/*
	...
	Example:
		...
		#include "PersistentFunctionsMV.h"
		...
		char* MyRead(char** error)
		{
			...
			if(error == NULL && connectionInfo != NULL)
			{
				...
				result = LkRead(error, connectionInfo, "LK.CUSTOMERS", recordIds, "", options, "", 0);
	...
	Example:
		...
		char* MyUpdate(char** error)
		{
			...
			if(error == NULL && connectionInfo != NULL)
			{
				...
				result = LkUpdate(error, connectionInfo, "LK.CUSTOMERS", updateBufffer, options, "", 0);
				LkFreeMemory(options);
...
DllEntry char* LkUpdate(char** error, char* connectionInfo, const char* const filename, const char* const records, const char* const updateOptions, const char* const customVars, uint32_t receiveTimeout)
{
	DataFormatTYPE inputFormat = DataFormatTYPE_MV;		
	DataFormatCruTYPE outputFormat = DataFormatCruTYPE_MV;		
	char* result = Base_LkUpdate(error, connectionInfo, filename, records, updateOptions, inputFormat, outputFormat, customVars, receiveTimeout);
	...
	Example:
		...
		char* MyUpdatePartial(char** error)
		{
			...
			if(error == NULL && connectionInfo != NULL)
			{
				...
				char* options = LkCreateUpdateOptions(FALSE, TRUE, TRUE, FALSE, FALSE, FALSE);
				result = LkUpdatePartial(error, connectionInfo, "LK.CUSTOMERS", updateBufffer, "NAME", options, "", 0);
				LkFreeMemory(options);
				LkFreeMemory(updateBufffer);
...
DllEntry char* LkUpdatePartial(char** error, char* connectionInfo, const char* const filename, const char* const records, const char* const dictionaries, const char* const updateOptions, const char* const customVars, uint32_t receiveTimeout)
{
	DataFormatTYPE inputFormat = DataFormatTYPE_MV;		
	DataFormatCruTYPE outputFormat = DataFormatCruTYPE_MV;		
	char* result = Base_LkUpdatePartial(error, connectionInfo, filename, records, dictionaries, updateOptions, inputFormat, outputFormat, customVars, receiveTimeout);
	...
	Example:
		...
		char* MyNew(char** error)
		{
			...
			if(error == NULL && connectionInfo != NULL)
			{
				...
				result = LkNew(error, connectionInfo, "LK.CUSTOMERS", newBuffer, options, "", 0);
...
DllEntry char* LkNew(char** error, char* connectionInfo, const char* const filename, const char* const records, const char* const newOptions, const char* const customVars, uint32_t receiveTimeout)
{
	DataFormatTYPE inputFormat = DataFormatTYPE_MV;		
	DataFormatCruTYPE outputFormat = DataFormatCruTYPE_MV;		
	char* result = Base_LkNew(error, connectionInfo, filename, records, newOptions, inputFormat, outputFormat, customVars, receiveTimeout);
	...
	Example:
		...
		char* MyDelete(char** error)
		{
			...
			if(error == NULL && connectionInfo != NULL)
			{
				char* recordId = "2";			// For multirecords, use LkComposeRecordIds
				char* originalRecord = "";		// For multirecords, use LkComposeRecords
				char* deleteBufffer = LkComposeDeleteBuffer(recordId, records);
				
				char* options = lkCreateDeleteOptions(TRUE, recoverRecordIdType);
				result = LkDelete(error, connectionInfo, "LK.CUSTOMERS", deleteBufffer, options, "", 0);
				LkFreeMemory(options);
				LkFreeMemory(deleteBufffer);
	...
	Example:
		...
		public char* MySelect(char** error)
		{
			...
			if(error == NULL && connectionInfo != NULL)
			{
				...
				result = LkSelect(error, connectionInfo, "LK.CUSTOMERS", "", "BY ID", "", "", options, "", 0);
				LkFreeMemory(options);
				LkLogout(error, connectionInfo, "", 0);
				LkFreeMemory(connectionInfo);
			}
