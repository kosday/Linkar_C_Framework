...
CL Test5-DirectCmdJSON.c /I ..\Linkar.Commands /I ..\includes /D__LK_STATIC_LIB__ %BIN_DIR_LIB%Linkar.Commands.Direct.JSON.lib /Fe%BIN_DIR_LIB%Test5-DirectCmdJSON.exe
REM Test5-DirectCmdJSON program with Dynamic Libraries
CL Test5-DirectCmdJSON.c /I ..\Linkar.Commands /I ..\includes /D__LK_DYNAMIC_LIB__ %BIN_DIR_DLL%Linkar.Commands.Direct.JSON.lib %BIN_DIR_DLL%Linkar.lib /Fe%BIN_DIR_DLL%Test5-DirectCmdJSON.exe
...
CL Test5-DirectCmdXML.c /I ..\Linkar.Commands /I ..\includes /D__LK_STATIC_LIB__ %BIN_DIR_LIB%Linkar.Commands.Direct.XML.lib /Fe%BIN_DIR_LIB%Test5-DirectCmdXML.exe
REM Test5-DirectCmdXML program with Dynamic Libraries
CL Test5-DirectCmdXML.c /I ..\Linkar.Commands /I ..\includes /D__LK_DYNAMIC_LIB__ %BIN_DIR_DLL%Linkar.Commands.Direct.XML.lib %BIN_DIR_DLL%Linkar.lib /Fe%BIN_DIR_DLL%Test5-DirectCmdXML.exe
...
CL Test5-PersistentCmdJSON.c /I ..\Linkar.Commands /I ..\includes /I ..\Linkar.Commands  /D__LK_STATIC_LIB__ %BIN_DIR_LIB%Linkar.Commands.Persistent.JSON.lib %BIN_DIR_LIB%Linkar.Strings.lib /Fe%BIN_DIR_LIB%Test5-PersistentCmdJSON.exe
REM Test5-PersistentCmdJSON program with Dynamic Libraries
CL Test5-PersistentCmdJSON.c /I ..\Linkar.Commands /I ..\includes /I ..\Linkar.Commands  /D__LK_DYNAMIC_LIB__ %BIN_DIR_DLL%Linkar.Commands.Persistent.JSON.lib %BIN_DIR_DLL%Linkar.lib /Fe%BIN_DIR_DLL%Test5-PersistentCmdJSON.exe
...
CL Test5-PersistentCmdXML.c /I ..\Linkar.Commands /I ..\includes /I ..\Linkar.Commands  /D__LK_STATIC_LIB__ %BIN_DIR_LIB%Linkar.Commands.Persistent.XML.lib %BIN_DIR_LIB%Linkar.Strings.lib /Fe%BIN_DIR_LIB%Test5-PersistentCmdXML.exe
REM Test5-PersistentCmdXML program with Dynamic Libraries
CL Test5-PersistentCmdXML.c /I ..\Linkar.Commands /I ..\includes /I ..\Linkar.Commands  /D__LK_DYNAMIC_LIB__ %BIN_DIR_DLL%Linkar.Commands.Persistent.XML.lib %BIN_DIR_DLL%Linkar.lib /Fe%BIN_DIR_DLL%Test5-PersistentCmdXML.exe
